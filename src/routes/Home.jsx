...
export default function Home() {
  ...
  const { data: charactersData, isLoading: charactersIsLoading } = useQuery("charactersData", charactersList);
  ...
  return (
    <>
      <HelmetProvider>
        ...
        {/* Comics 컨텐츠 리스트*/}
        <VStack w="full" position={"relative"} h={"400px"} data-aos="fade-up">
          {/* 한박스 위로 올라오게 하는 범위지정 */}
